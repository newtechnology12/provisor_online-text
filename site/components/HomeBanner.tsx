...
export default function HomeBanner() {
  ...
  return (
    <div className="home-banner md:pt-12 md:h-fit p h-[700px] relative overflow-hidden sm:rounded-none g-green-200 sm:my-0 md:py-0  py-14 rounded-md my-0 flex flex-col items-start justify-start sm:px-4 px-10">
      <img
        src="images/bg.png"
      ...
      <div className="max-w-5xl md:py-12 w-full py-36 relative z-[45]  mx-auto">
        <div className="flex max-w-xl relative z-30 flex-col">
          ...
          <p className="sm:line-clamp-2- md:font-medium ml-0 max-w-lg mx-auto my-5 leading-8 text-[16px] font-medium- md:text-slate-700 text-slate-600">
