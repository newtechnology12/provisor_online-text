...
export default function HomeBanner() {
  ...
  return (
    <div className="home-banner md:pt-12 p sm:h-[83vh] h-[650px] relative overflow-hidden sm:rounded-none g-green-200 sm:my-0 md:py-0  py-14 rounded-md my-0 flex flex-col items-start justify-start sm:px-4 px-10">
      <img
        src="images/bg.png"
      ...
      <img
        ...
        className="h-full w-full hidden sm:block sm:object-right  left-0 object-cover absolute z-10 top-0"
        alt=""
      />
      {/* <div className="w-full hidden md:block absolute h-full bg-[#0C8C7C] backdrop-blur-sm z-40 left-0 opacity-20"></div> */}
      <div className="max-w-5xl md:py-8 w-full py-36 relative z-[45]  mx-auto">
        <div className="flex sm:gap-1 sm:items-center sm:justify-center sm:mx-auto sm:text-center max-w-xl relative z-30 flex-col">
          ...
          <h4 className="text-3xl sm:text-xl md:leading-9 leading-[50px] text-[#0C8C7C] mx-auto font-bold capitalize">
            Urubuga rwambere mu rwanda rufasha abantu bose kubona Provisoire
          </h4>
          <p className="sm:line-clamp-2- sm:px-8 font-medium ml-0 max-w-[450px] mx-auto my-5 mt-3 leading-8 text-[16.5px] font-medium- md:text-slate-700- text-slate-500">
